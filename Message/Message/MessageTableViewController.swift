...
class MessageTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let btn = UIBarButtonItem(image: UIImage(named: "addMesg.png"), landscapeImagePhone: nil, style: UIBarButtonItemStyle.Plain, target: self, action: Selector("addMesg"))
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        testDetail.insideMesg = self.messageitem[indexPath.row]
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
                ...
                let cell = MyTableViewCell(reuseIdentifier:"test", item:cell_Data)
                return cell
    }
